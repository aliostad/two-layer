...
resource "azurerm_linux_web_app" "layer2" {
  ...
  app_settings = {
    ...
    CORECLR_PROFILER_PATH    = "/opt/datadog/apm/library/dotnet/Datadog.Trace.ClrProfiler.Native.so"
    DD_DOTNET_TRACER_HOME    = "/opt/datadog/apm/library/dotnet"
    DD_TRACE_ENABLED         = "true"
    DD_TRACE_STARTUP_LOGS    = "true"
    DD_TRACE_DEBUG           = "true"
    DD_LOG_LEVEL             = "debug"
    LD_PRELOAD               = "/opt/datadog/apm/library/dotnet/linux-x64/Datadog.Linux.ApiWrapper.x64.so"
    DD_RUNTIME_METRICS_ENABLED = "true"
    DD_PROFILING_ENABLED     = "true"
    DD_PROFILING_ALLOCATION_ENABLED = "1"
    DD_PROFILING_CONTENTION_ENABLED = "1"
    DD_TRACE_LOG_DIRECTORY   = "/home/LogFiles/datadog/dotnet"
